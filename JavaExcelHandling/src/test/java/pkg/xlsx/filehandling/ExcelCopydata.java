...
public class ExcelCopydata {
	...
	public void excelCopyData() throws IOException {
		File inputfile = new File("../JavaExcelHandling/readExcelData.xlsx");  //read file connection
		File outputfile =new  File("../JavaExcelHandling/WriteExceldata.xlsx"); //write file connection
		...
		XSSFSheet inputsheet = xw.getSheetAt(0); //input sheet object
		...
		XSSFSheet outputsheet = xw.createSheet("Rishi"); //output sheet object
